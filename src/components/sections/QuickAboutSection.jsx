      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
                {[
                  { text: '50+ Trucks', iconType: 'truck' },
                  { text: '48 States', iconType: 'location' },
                  { text: 'Top Rated', iconType: 'star' },
                  { text: '24/7 Support', iconType: 'support' }
                ].map((feature, index) => (
                  <motion.div
                    key={index}
                    variants={{
