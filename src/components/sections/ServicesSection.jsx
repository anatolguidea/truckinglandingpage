        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative rounded-lg shadow-lg overflow-hidden transition-all duration-300 h-72 group hover:shadow-3xl hover:shadow-gray-900/40 hover:scale-[1.02]"
              style={{
            ...
            >
              ...
              <div className="relative z-10 p-8 text-white h-full flex flex-col">
                ...
                {/* Request Quote Button - Static Position */}
                <div className="absolute bottom-6 left-0 right-0 flex justify-center z-20">
                  <motion.button
                    onClick={scrollToQuoteForm}
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="text-white px-6 py-3 rounded-lg font-semibold transition-all duration-200 shadow-lg cursor-pointer"
                    style={{
